...
import org.dase.iecii.parser.antlr.simple_parser_v2BaseVisitorImpl;
import org.dase.iecii.parser.antlr.simple_parser_v2Lexer;
import org.dase.iecii.parser.antlr.simple_parser_v2Parser;
...
public class TestParser_antlr_v2 {
...
//        String str = " exists R1. ((WN_Ceiling  AND  not (Baby) ))";
        ...
        for (int i = 0; i < testCases.size(); i++) {
            try {
                ...
                simple_parser_v2Lexer lexer = new simple_parser_v2Lexer(inputStream);
                CommonTokenStream tokenStream = new CommonTokenStream(lexer);
                simple_parser_v2Parser antparser = new simple_parser_v2Parser(tokenStream);

                CandidateSolutionV1 candidateSolutionV1 = null;
                simple_parser_v2Parser.ParsecandidatesolutionContext tree = antparser.parsecandidatesolution();

                simple_parser_v2BaseVisitorImpl simple_parser_v6BaseVisitor = new simple_parser_v2BaseVisitorImpl(owlDataFactory,ontology,owlReasoner);
...
//                    for (simple_parser_v2Parser.GroupedcandidateclassesContext groupedcandidateclassesContext : tree.groupedcandidateclasses()) {
//
...
//                        }
//
//                        for (simple_parser_v2Parser.ParsecandidateclassContext parsecandidateclassContext : groupedcandidateclassesContext.parsecandidateclass()) {
//
...
//
//                            // horn clauses
//                            for (simple_parser_v2Parser.ParseconjunctivehornclauseContext parseconjunctivehornclauseContext : parsecandidateclassContext.parseconjunctivehornclause()) {
//
...
//                                // posclasses
//                                for (simple_parser_v2Parser.ParseclassidContext parseposclassContext : parseconjunctivehornclauseContext.parseposclasses().parseclassid()) {
...
//                                }
//                                // neg classes
//                                for (simple_parser_v2Parser.ParseclassidContext parsenegclassContext : parseconjunctivehornclauseContext.parsenegclasses().parseclassid()) {
...
//                asd.visitParsecandidatesolution(antparser.parsecandidatesolution());
                ...
                lexer = new simple_parser_v2Lexer(inputStream);
                tokenStream = new CommonTokenStream(lexer);
                antparser = new simple_parser_v2Parser(tokenStream);
