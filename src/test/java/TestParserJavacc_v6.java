...
import org.dase.parser.parser_simple.SimpleParserJavacc_v6;
...
public class TestParserJavacc_v6 {
...
//        String str = " exists R1. ((WN_Ceiling  AND  not (Baby) ))";
        ...
        for(int i=0;i<testCases.size();i++){
            try {
                ...
                // our parser
                SimpleParserJavacc_v6 parser = new SimpleParserJavacc_v6(stream);
