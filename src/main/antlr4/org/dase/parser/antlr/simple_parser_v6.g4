...
* parser rules
*/
parsecandidatesolution  : g=groupedcandidateclasses ( AND groupedcandidateclasses )*   ;
...
parsecandidateclass : OPENPAR?  parseconjunctivehornclause ( AND parseconjunctivehornclause)* CLOSEPAR?  ;
parseconjunctivehornclause : OPENPAR? OPENPAR? parseposclasses CLOSEPAR? ( AND NOT OPENPAR parsenegclasses CLOSEPAR )? CLOSEPAR? ;
