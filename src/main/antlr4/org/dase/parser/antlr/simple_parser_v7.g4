grammar simple_parser_v7;

// to test: antlr4 -o . -lib . -no-listener -no-visitor simple_parser_v6.g4; javac *.java; grun simple_parser_v6 parsecandidatesolution -gui testcase13.png.txt
