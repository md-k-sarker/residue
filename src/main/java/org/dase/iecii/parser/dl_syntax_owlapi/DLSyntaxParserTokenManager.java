...
class DLSyntaxParserTokenManager implements org.dase.iecii.parser.dl_syntax_owlapi.DLSyntaxParserConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    public DLSyntaxParserTokenManager(JavaCharStream stream){
      ...
      if (org.dase.iecii.parser.dl_syntax_owlapi.JavaCharStream.staticFlag)
