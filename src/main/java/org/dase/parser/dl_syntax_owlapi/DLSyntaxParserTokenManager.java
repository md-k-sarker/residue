...
class DLSyntaxParserTokenManager implements org.dase.parser.dl_syntax_owlapi.DLSyntaxParserConstants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    public DLSyntaxParserTokenManager(JavaCharStream stream){
      ...
      if (org.dase.parser.dl_syntax_owlapi.JavaCharStream.staticFlag)
