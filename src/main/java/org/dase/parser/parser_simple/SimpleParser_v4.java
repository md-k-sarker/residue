/* SimpleParser_v4.java */
/* Generated By:JavaCC: Do not edit this line. SimpleParser_v4.java */
...
public class SimpleParser_v4 implements SimpleParser_v4Constants {
...
{if ("" != null) return getIRIFromId(t.image);}
  ...
  private boolean jj_3R_11()
 {
  ...
  public SimpleParser_v4TokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x20000,0x40000,0x100400,0x20000,0x20000,};
   }
  ...
  public SimpleParser_v4(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public SimpleParser_v4(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new SimpleParser_v4TokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public SimpleParser_v4(java.io.Reader stream) {
  ...
  public SimpleParser_v4(SimpleParser_v4TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(SimpleParser_v4TokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
