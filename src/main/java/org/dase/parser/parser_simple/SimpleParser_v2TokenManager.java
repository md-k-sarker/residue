/* SimpleParser_v2TokenManager.java */
/* Generated By:JavaCC: Do not edit this line. SimpleParser_v2TokenManager.java */
...
/** Token Manager. */
@SuppressWarnings("unused")class SimpleParser_v2TokenManager implements SimpleParser_v2Constants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public SimpleParser_v2TokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public SimpleParser_v2TokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
