/* SimpleParser_v4TokenManager.java */
/* Generated By:JavaCC: Do not edit this line. SimpleParser_v4TokenManager.java */
...
/** Token Manager. */
@SuppressWarnings("unused")class SimpleParser_v4TokenManager implements SimpleParser_v4Constants {
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public SimpleParser_v4TokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public SimpleParser_v4TokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
